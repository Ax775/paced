...
const STRINGS = {
  nl: {
    ...
    /* Premium / abonnement */
    'premium.unlock':            'Ontgrendel premium',
    'premium.price':             '€3',
    'premium.priceUnit':         'per maand',
    'premium.banner.trial':      'Nog {n} dagen gratis proef',
    'premium.banner.expired':    'Je gratis proefperiode is afgelopen',
    'premium.banner.cta':        'Upgraden',
    'premium.feat.insights':     'Inzichten — grafieken, badges & symptoomanalyse',
    'premium.feat.partner':      'Partner-koppeling',
    'premium.feat.export':       'Data-export (CSV, JSON & Apple Health)',
    'premium.locked.insights.title': 'Inzichten is premium',
    'premium.locked.insights.body':  'Grafieken, mijlpalen en symptoomanalyse per fase zitten in Paced Premium.',
    'premium.locked.partner.title':  'Partner-koppeling is premium',
    'premium.locked.partner.body':   'Deel je cyclusfase met je partner met Paced Premium.',
    'premium.locked.export.title':   'Data-export is premium',
    'premium.locked.export.body':    'Exporteer je gegevens naar CSV, JSON of Apple Health met Paced Premium.',
    'premium.modal.title':       'Paced Premium',
    'premium.modal.sub':         'Ontgrendel alle functies voor €3 per maand.',
    'premium.modal.trialSub':    'Je hebt nog {n} dagen gratis. Daarna €3 per maand — maandelijks opzegbaar.',
    'premium.modal.subscribe':   'Abonneer voor €3/maand',
    'premium.modal.loginFirst':  'Log eerst in met je e-mail, zodat je abonnement aan je account gekoppeld wordt.',
    'premium.modal.loginCta':    'Stuur inloglink',
    'premium.modal.emailLabel':  'E-mailadres',
    'premium.modal.checkInbox':  'We stuurden een inloglink naar {email}. Open hem en kom terug om te abonneren.',
    'premium.modal.redirecting': 'Doorsturen naar de betaalpagina…',
    'premium.modal.sending':     'Bezig…',
    'premium.modal.error':       'Er ging iets mis. Probeer het opnieuw.',
    'premium.modal.notConfigured':'Betalingen zijn nog niet geconfigureerd. Probeer het later.',
    'premium.modal.later':       'Misschien later',
    'premium.modal.legal':       'Maandelijks opzegbaar. Veilige betaling via Stripe. Tijdens je proefperiode wordt er nog niets afgeschreven.',
    'premium.status.title':      'Abonnement',
    'premium.status.active':     'Premium actief',
    'premium.status.trial':      'Gratis proef — nog {n} dagen',
    'premium.status.free':       'Gratis versie',
    'premium.status.manage':     'Beheren',
  ...
  en: {
    ...
    'premium.price':             '€3',
    'premium.priceUnit':         'per month',
    'premium.banner.trial':      '{n} days left in your free trial',
    'premium.banner.expired':    'Your free trial has ended',
    'premium.banner.cta':        'Upgrade',
    'premium.feat.insights':     'Insights — charts, badges & symptom analysis',
    'premium.feat.partner':      'Partner linking',
    'premium.feat.export':       'Data export (CSV, JSON & Apple Health)',
    'premium.locked.insights.title': 'Insights is premium',
    'premium.locked.insights.body':  'Charts, milestones and per-phase symptom analysis are part of Paced Premium.',
    'premium.locked.partner.title':  'Partner linking is premium',
    'premium.locked.partner.body':   'Share your cycle phase with your partner with Paced Premium.',
    'premium.locked.export.title':   'Data export is premium',
    'premium.locked.export.body':    'Export your data to CSV, JSON or Apple Health with Paced Premium.',
    'premium.modal.title':       'Paced Premium',
    'premium.modal.sub':         'Unlock every feature for €3 per month.',
    'premium.modal.trialSub':    'You have {n} free days left. After that it’s €3/month — cancel anytime.',
    'premium.modal.subscribe':   'Subscribe for €3/month',
    'premium.modal.loginFirst':  'Log in with your email first, so your subscription is linked to your account.',
    'premium.modal.loginCta':    'Send login link',
    'premium.modal.emailLabel':  'Email address',
    'premium.modal.checkInbox':  'We sent a login link to {email}. Open it and come back to subscribe.',
    'premium.modal.redirecting': 'Redirecting to checkout…',
    'premium.modal.sending':     'Working…',
    'premium.modal.error':       'Something went wrong. Please try again.',
    'premium.modal.notConfigured':'Payments aren’t configured yet. Please try later.',
    'premium.modal.later':       'Maybe later',
    'premium.modal.legal':       'Cancel anytime. Secure payment via Stripe. Nothing is charged during your trial.',
    'premium.status.title':      'Subscription',
    'premium.status.active':     'Premium active',
    'premium.status.trial':      'Free trial — {n} days left',
    'premium.status.free':       'Free version',
    'premium.status.manage':     'Manage',
