...
const STRINGS = {
  nl: {
    ...
    /* cycle calendar */
    'calendar.title':              'Cyclus-kalender',
    'calendar.next':               'volgende: {date}',
    'calendar.currentDay':         'Vandaag is dag {day} van {total} in je cyclus.',
    'calendar.cellAria':           '{date} — {tag}',
    'calendar.tagPeriod':          'Menstruatie',
    'calendar.tagFertile':         'Vruchtbaar venster',
    'calendar.tagOvulation':       'Ovulatie',
    'calendar.tagPredicted':       '{tag} (voorspeld)',
    'calendar.tagNone':            'Geen markering',
    'calendar.tagNoneCell':        'Geen markering — gewone cyclusdag.',
    'calendar.legend.period':      'Menstruatie',
    'calendar.legend.fertile':     'Vruchtbaar',
    'calendar.legend.ovulation':   'Ovulatie',
    'calendar.legend.today':       'Vandaag',
    'calendar.foot':               'Lichtere kleuren zijn voorspellingen — ze worden steviger naarmate je meer logt.',
    'calendar.editStart':          'Startdatum aanpassen',
    'calendar.editStart.title':    'Startdatum huidige cyclus',
    'calendar.editStart.hint':     'Klopt de huidige cyclusdag niet? Pas hier de eerste dag van je laatste menstruatie aan — Aura herrekent direct.',
    'calendar.editStart.save':     'Opslaan',
    'calendar.editStart.cancel':   'Annuleer',
    ...
    'onb.intro.cta.named':   'Fijn je te ontmoeten, {first} ✓',
    ...
    'onb.welcome.title.named': 'Welkom, {first}!',
  ...
  en: {
    ...
    'calendar.next':               'next: {date}',
    'calendar.currentDay':         'Today is day {day} of {total} in your cycle.',
    'calendar.cellAria':           '{date} — {tag}',
    'calendar.tagPeriod':          'Period',
    'calendar.tagFertile':         'Fertile window',
    'calendar.tagOvulation':       'Ovulation',
    'calendar.tagPredicted':       '{tag} (predicted)',
    'calendar.tagNone':            'No marking',
    'calendar.tagNoneCell':        'No marking — regular cycle day.',
    ...
    'calendar.foot':               'Lighter colors are predictions — they get more confident as you log more.',
    'calendar.editStart':          'Edit start date',
    'calendar.editStart.title':    'Current cycle start date',
    'calendar.editStart.hint':     "If the current cycle day looks wrong, set the first day of your last period here — Aura recalculates instantly.",
    'calendar.editStart.save':     'Save',
    'calendar.editStart.cancel':   'Cancel',
    ...
    'onb.intro.cta.named':   'Nice to meet you, {first} ✓',
    ...
    'onb.cycle.title.named':  '{first}, tell me about your cycle.',
    ...
    'onb.cycle.lastPeriod':   'When did your last period start?',
    ...
    'onb.welcome.title.named': 'Welcome, {first}!',
